...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getBookingsByOwner(String state, long userId, int from, int size) {
        Map<String, Object> parameters = Map.of(
                "state", state,
                "from", from,
                "size", size
    ...
    public ResponseEntity<Object> approveBooking(long userId, long bookingId, boolean isApproved) {
        ...
        return post("/approve" + bookingId + "?approved={approved}", userId, parameters);
    }
}
